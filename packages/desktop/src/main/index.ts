...
const main = Effect.gen(function* () {
  ...
  const product = desktopProduct(process.env.OPENCODE_CLIENT, app.isPackaged ? CHANNEL : "dev")
  const appId = product.id
  ...
  preferAppEnv(app.getPath("userData"), product.client)
