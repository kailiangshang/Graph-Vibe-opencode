...
import { CURRENT_PLAN_EMPTY_MESSAGE, type GraphView, normalizeWorkflow, reconcileSelection } from "./graph-helpers"
...
export default function GraphPage() {
  ...
  const modeMutation = createMutation(() => ({
    ...
    onError: async () => {
      setState("conflict", "The workflow changed. Status was refreshed; review it before changing mode again.")
      await refresh()
    },
  }))
